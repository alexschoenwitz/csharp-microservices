    ...
    public class BlueprintGrpcService : BlueprintProto.BlueprintService.BlueprintServiceBase
    {
            ...
            BlueprintProto.GetBlueprintRequest request, ServerCallContext context)
        {
            try
            {
                ...
                var blueprint = await _blueprintService.GetByIdAsync(id, context.CancellationToken);
            ...
            BlueprintProto.CreateBlueprintRequest request, ServerCallContext context)
        {
            try
            {
                ...
                var blueprint = await _blueprintService.CreateAsync(createRequest, context.CancellationToken);
            ...
            BlueprintProto.UpdateBlueprintRequest request, ServerCallContext context)
        {
            try
            {
                ...
                var blueprint = await _blueprintService.UpdateAsync(updateRequest, context.CancellationToken);
            ...
            BlueprintProto.DeleteBlueprintRequest request, ServerCallContext context)
        {
            ...
            {
                var id = Guid.Parse(request.Id);
                var success = await _blueprintService.DeleteAsync(id, context.CancellationToken);
